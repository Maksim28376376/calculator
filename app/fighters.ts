...
export const fighters: Record<string, Fighter> = {
  ...
  "417": {
    ...
    bio: "“Bullet” — a long-reigning women's flyweight champion and pound-for-pound great.",
    fact: "A decorated Muay Thai world champion before MMA, she piled up the most title defenses in UFC flyweight history.",
    look: { skin: "#eab98f", hair: "#6a4a2a", hairStyle: "ponytail", facial: "none", trunks: "#e8112d", trunksAccent: "#ffef00", gloves: "#e8112d", female: true },
  },
  "352": {
    name: "Gunnar Nelson",
    bio: "A karate-and-jiu-jitsu welterweight and cult favorite from Iceland.",
    fact: "Began his UFC run unbeaten, using slick grappling to submit opponents as a BJJ black belt.",
  ...
  "056": {
    ...
    bio: "A technical Belgian welterweight and former Strikeforce champion.",
    fact: "Won the final Strikeforce welterweight title, then carried his reputation into the UFC.",
    look: { skin: "#c98a5e", hair: "#111318", hairStyle: "short", facial: "none", trunks: "#000000", trunksAccent: "#fdda24", gloves: "#ef3340" },
  },
  "703": {
    name: "Ľudovít Klein",
    bio: "A slick Slovak striker fighting between featherweight and lightweight.",
    fact: "Announced himself with a first-round knockout on his UFC debut.",
    look: { skin: "#eab98f", hair: "#6a4a2a", hairStyle: "short", facial: "stubble", trunks: "#ffffff", trunksAccent: "#0b4ea2", gloves: "#ee1c25" },
  },
  "440": {
    name: "Modestas Bukauskas",
    bio: "A Lithuanian light heavyweight known as “The Baltic Gladiator.”",
    fact: "Flies the Lithuanian flag in the octagon and bounced back from a brutal injury to keep winning.",
    look: { skin: "#eab98f", hair: "#6a4a2a", hairStyle: "buzz", facial: "beard", trunks: "#fdb913", trunksAccent: "#006a44", gloves: "#006a44" },
  },
  "498": {
    name: "Ion Cutelaba",
    bio: "“The Hulk” — an explosive, all-action Moldovan light heavyweight.",
    fact: "Built his reputation on wild, all-or-nothing brawls and fast starts.",
    look: { skin: "#eab98f", hair: "#111318", hairStyle: "buzz", facial: "beard", trunks: "#0046ae", trunksAccent: "#ffd200", gloves: "#cc092f" },
  },
  "642": {
    name: "Nicolae Negumereanu",
    bio: "One of the few Romanians to reach the UFC, a light heavyweight.",
    fact: "Earned his place on the roster and became Romania's flag-bearer at 205 pounds.",
    look: { skin: "#eab98f", hair: "#111318", hairStyle: "short", facial: "beard", trunks: "#002b7f", trunksAccent: "#fcd116", gloves: "#ce1126" },
  },
  "862": {
    name: "Omar Morales",
    bio: "A Venezuelan lightweight who came up the hard way.",
    fact: "Arrived in the UFC unbeaten after a long pro career and a Contender Series win.",
    look: { skin: "#b07848", hair: "#111318", hairStyle: "short", facial: "beard", trunks: "#ffcc00", trunksAccent: "#00247d", gloves: "#cf142b" },
  },
  "388": {
    name: "Randy Brown",
    bio: "“Rude Boy” — a rangy, Jamaican-born welterweight.",
    fact: "Earned his shot on Dana White's Contender Series and became a durable UFC mainstay.",
    look: { skin: "#6f4326", hair: "#111318", hairStyle: "short", facial: "beard", trunks: "#009b3a", trunksAccent: "#fed100", gloves: "#000000" },
  },
  "496": {
    name: "Danaa Batgerel",
    bio: "A hard-hitting Mongolian bantamweight.",
    fact: "Scored a highlight knockout to help put Mongolia on the UFC map.",
    look: { skin: "#e0c090", hair: "#111318", hairStyle: "short", facial: "none", trunks: "#c4272e", trunksAccent: "#f9cf02", gloves: "#015197" },
  },
  "360": {
    name: "Jeka Saragih",
    bio: "A crowd-pleasing featherweight and pioneer for Indonesian MMA.",
    fact: "Became the first Indonesian fighter in the UFC after reaching the Road to UFC final.",
    look: { skin: "#b07848", hair: "#111318", hairStyle: "slick", facial: "none", trunks: "#ff0000", trunksAccent: "#ffffff", gloves: "#ffffff" },
  },
  "170": {
    name: "Sabina Mazo",
    bio: "A Colombian flyweight with a Muay Thai base.",
    fact: "Came up through the Combate Americas scene before joining the UFC's flyweight division.",
    look: { skin: "#d29a68", hair: "#4a3222", hairStyle: "ponytail", facial: "none", trunks: "#fcd116", trunksAccent: "#ce1126", gloves: "#003893", female: true },
  },
  "368": {
    name: "Amir Albazi",
    bio: "“The Prince” — a Baghdad-born flyweight contender.",
    fact: "Climbed into the flyweight rankings with a razor-thin win over Kai Kara-France.",
    look: { skin: "#d29a68", hair: "#111318", hairStyle: "short", facial: "beard", trunks: "#ffffff", trunksAccent: "#ce1126", gloves: "#007a3d" },
  },
  "504": {
    name: "Ottman Azaitar",
    bio: "“The Ottoman” — a heavy-handed Moroccan lightweight.",
    fact: "Reached the UFC unbeaten with almost all of his wins coming by knockout.",
    look: { skin: "#c98a5e", hair: "#111318", hairStyle: "buzz", facial: "beard", trunks: "#c1272d", trunksAccent: "#006233", gloves: "#006233" },
  },
  "070": {
    name: "Mirsad Bektić",
    bio: "A Bosnian-born featherweight once tipped as a future champion.",
    fact: "Arrived in the UFC as one of the most hyped featherweight prospects of his generation.",
    look: { skin: "#eab98f", hair: "#111318", hairStyle: "short", facial: "stubble", trunks: "#002395", trunksAccent: "#fecb00", gloves: "#fecb00" },
  },
  "348": {
    name: "Norbert Növényi Jr.",
    bio: "A Hungarian middleweight with a judo and wrestling pedigree.",
